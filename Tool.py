...
from src.ImageProcess import Graphics
...
def print_help():
    ...
    2) small compress(2M to 500K around)
...
def handle_photo():
    ...
    '''
    src_dir, des_dir = "photos/","min_photos/"
    photo_list = list_photo(src_dir)
    img_info = {}
    photo_info = []
    for p in photo_list:
        file_list = list_img_file(src_dir+p)
        index = ""
        img_list=[]
        for i in file_list:
            info,_ = i.split(".")
