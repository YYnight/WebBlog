---
title: 网易云音乐参数加密算法
date: 2018-01-12 11:23:05
tags: [Java,加密]
category: code
---

&emsp; 通常我们再写自己的音乐播放器的时候，都会在网上找一些比较主流的音乐播放器api，例如QQ音乐、网易云音乐、百度音乐等等，而在使用网易云音乐api的时候，由于他的参数时需要加密无法直接使用的，所以我们必须要知道他是怎么进行加密的，这篇文章就是对参数进行加密的java代码。
